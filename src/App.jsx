...
import {
  ...
  AlertCircle, CheckCircle, ChevronDown, Copy, Target, Star
} from "lucide-react";
import {
...
const dadosIniciais = {
  ...
  provasPassadas: {
    a1: [
      { id: "p1", data: "2024-10-06", nome: "Maratona de Porto Alegre", distancia: 42.195, tempo: "03:52:10", pace: "5:30" },
      { id: "p2", data: "2024-08-18", nome: "Meia Maratona Farroupilha", distancia: 21.1, tempo: "01:48:30", pace: "5:08" },
      { id: "p3", data: "2024-06-09", nome: "10K Night Run", distancia: 10, tempo: "00:49:20", pace: "4:56" },
      { id: "p4", data: "2024-04-21", nome: "5K São Borja", distancia: 5, tempo: "00:23:45", pace: "4:45" },
    ],
    a2: [
      { id: "p5", data: "2024-09-22", nome: "Corrida do Bem 10K", distancia: 10, tempo: "00:52:10", pace: "5:13" },
      { id: "p6", data: "2024-07-14", nome: "5K da Independência", distancia: 5, tempo: "00:25:00", pace: "5:00" },
      { id: "p7", data: "2024-05-05", nome: "Trail 15K Serra Gaúcha", distancia: 15, tempo: "01:22:40", pace: "5:31" },
    ],
    a3: [
      { id: "p8", data: "2024-11-03", nome: "Meia Maratona RS", distancia: 21.1, tempo: "02:05:20", pace: "5:56" },
      { id: "p9", data: "2024-09-01", nome: "10K Verde e Amarelo", distancia: 10, tempo: "01:00:15", pace: "6:01" },
      { id: "p10", data: "2024-06-23", nome: "5K Solidária", distancia: 5, tempo: "00:29:10", pace: "5:50" },
    ],
  },
  provasFuturas: {
    a1: [
      { id: "f1", data: "2025-03-02", nome: "Maratona de SP", distancia: 42.195, objetivoTempo: "03:45:00", objetivoPace: "5:19" },
      { id: "f2", data: "2025-01-19", nome: "10K Verano Run", distancia: 10, objetivoTempo: "00:47:00", objetivoPace: "4:42" },
    ],
    a2: [
      { id: "f3", data: "2025-02-16", nome: "Meia Gaúcha", distancia: 21.1, objetivoTempo: "01:45:00", objetivoPace: "4:58" },
    ],
    a3: [
      { id: "f4", data: "2025-04-06", nome: "10K Primavera", distancia: 10, objetivoTempo: "00:58:00", objetivoPace: "5:48" },
    ],
  },
  pagamentos: {
    a1: {
      "2024-11": { status: "pago", data: "2024-11-05", obs: "" },
      "2024-10": { status: "pago", data: "2024-10-03", obs: "" },
      "2024-09": { status: "pago", data: "2024-09-02", obs: "" },
      "2024-08": { status: "pago", data: "2024-08-07", obs: "" },
      "2024-07": { status: "pago", data: "2024-07-04", obs: "" },
      "2024-06": { status: "pago", data: "2024-06-05", obs: "" },
    },
    a2: {
      "2024-11": { status: "pendente", data: "", obs: "Aguardando" },
      "2024-10": { status: "pago", data: "2024-10-08", obs: "" },
      "2024-09": { status: "pago", data: "2024-09-10", obs: "" },
      "2024-08": { status: "pago", data: "2024-08-06", obs: "" },
      "2024-07": { status: "pago", data: "2024-07-09", obs: "" },
      "2024-06": { status: "pago", data: "2024-06-08", obs: "" },
    },
    a3: {
      "2024-11": { status: "pago", data: "2024-11-01", obs: "" },
      "2024-10": { status: "pago", data: "2024-10-01", obs: "" },
      "2024-09": { status: "pago", data: "2024-09-01", obs: "" },
      "2024-08": { status: "pago", data: "2024-08-01", obs: "" },
      "2024-07": { status: "pago", data: "2024-07-01", obs: "" },
      "2024-06": { status: "pago", data: "2024-06-01", obs: "" },
    },
  },
  eventosCalendario: [
    { id: "e1", data: "2025-01-12", alunoId: "a1", nome: "10K Night Run", distancia: 10, tipo: "competição" },
    { id: "e2", data: "2025-01-19", alunoId: "a2", nome: "Treino Longo", distancia: 25, tipo: "treino" },
    { id: "e3", data: "2025-02-16", alunoId: "a3", nome: "Meia Maratona RS", distancia: 21.1, tipo: "competição" },
  ],
  treinos: {
    a1: {},
    a2: {},
...
// UTILITÁRIOS
// ============================================================
const LS_KEY = "endorfina_club_data";
...
const mesAno = (data) => data.substring(0, 7);
...
const cores = ["#00A859","#0088CC","#FF6B35","#9B59B6","#E74C3C","#F39C12"];
...
const Avatar = ({ nome, foto, size = 40 }) => {
  ...
  return (
    <div style={{
      ...
      background: "#00A859", display: "flex", alignItems: "center", justifyContent: "center",
...
const Toast = ({ msg, tipo, onClose }) => (
  <div style={{
    ...
    background: tipo === "erro" ? "#c0392b" : "#00A859",
...
const Modal = ({ titulo, onClose, children, largura = 640 }) => (
  <div style={{
    ...
    <div style={{
      ...
      width: "100%", maxWidth: largura, maxHeight: "90vh", overflow: "auto",
      padding: 28,
    }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        <h2 style={{ color: "#fff", fontSize: 18, fontWeight: 700, margin: 0 }}>{titulo}</h2>
        <button onClick={onClose} style={{ background: "#222", border: "none", color: "#fff", borderRadius: 8, padding: 6, cursor: "pointer", display: "flex" }}>
          <X size={18} />
        </button>
      </div>
      {children}
...
const TabelaEditavel = ({ colunas, linhas, onAdd, onRemove, onEdit }) => (
  <div style={{ overflowX: "auto" }}>
    <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
      ...
      <tbody>
        {linhas.length === 0 && (
          <tr><td colSpan={colunas.length + 1} style={{ color: "#444", padding: "20px 12px", textAlign: "center" }}>Nenhum registro</td></tr>
        )}
        {linhas.map((linha, i) => (
            ...
            {colunas.map(c => (
              <td key={c.key} style={{ padding: "8px 12px", color: "#ddd" }}>
                <input
                  ...
                  style={{ background: "transparent", border: "none", color: "#ddd", fontSize: 13, width: "100%", outline: "none", minWidth: c.minWidth || 80 }}
                />
              </td>
            ))}
            <td style={{ padding: "8px 12px", textAlign: "right" }}>
              <button onClick={() => onRemove(i)} style={{ background: "none", border: "none", color: "#c0392b", cursor: "pointer", padding: 4 }}>
                <Trash2 size={14} />
              </button>
            </td>
          </tr>
...
const DashboardAluno = ({ aluno, dados, onUpdate, toast }) => {
  const provasPassadas = dados.provasPassadas[aluno.id] || [];
  const provasFuturas = dados.provasFuturas[aluno.id] || [];
  ...
  const colunasFuturas = [
    ...
    { key: "nome", label: "Prova", minWidth: 140 },
    { key: "distancia", label: "Dist. (km)", type: "number" },
    { key: "objetivoTempo", label: "Obj. Tempo" },
    { key: "objetivoPace", label: "Obj. Pace" },
  ];

  // Métricas resumo
  const totalProvas = provasPassadas.length;
  const distanciaTotal = provasPassadas.reduce((s, p) => s + (+p.distancia || 0), 0).toFixed(1);
  const paces = provasPassadas.filter(p => p.pace && p.pace !== "–").map(p => paceParaSegundos(p.pace)).filter(v => !isNaN(v));
  ...
  const dadosGrafico = provasPassadas
    ...
    .map(p => ({
      ...
      pace: paceParaSegundos(p.pace) / 60,
      distancia: +p.distancia,
      nome: p.nome,
    }));

  const salvarAluno = () => {
    onUpdate("editarAluno", { ...form });
    setEditando(false);
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 4 }}>
              ...
              <span style={{ background: aluno.ativo ? "#00A85922" : "#66666622", color: aluno.ativo ? "#00A859" : "#888", fontSize: 12, padding: "3px 10px", borderRadius: 20, fontWeight: 700 }}>
                {aluno.ativo ? "Ativo" : "Inativo"}
              </span>
            </div>
            <div style={{ display: "flex", gap: 20, flexWrap: "wrap", color: "#888", fontSize: 13 }}>
              <span style={{ display: "flex", alignItems: "center", gap: 5 }}><MapPin size={13} />{aluno.cidade}</span>
              <span style={{ display: "flex", alignItems: "center", gap: 5 }}><Phone size={13} />{aluno.telefone}</span>
              <span style={{ display: "flex", alignItems: "center", gap: 5 }}><Mail size={13} />{aluno.email}</span>
              <span style={{ display: "flex", alignItems: "center", gap: 5 }}><Clock size={13} />Desde {aluno.dataInicio}</span>
            </div>
            <div style={{ marginTop: 8, display: "flex", gap: 10, flexWrap: "wrap" }}>
              <span style={{ background: "#00A85915", border: "1px solid #00A85933", color: "#00A859", fontSize: 12, padding: "3px 12px", borderRadius: 20, fontWeight: 700 }}>Plano: {aluno.plano}</span>
          ...
          <ResponsiveContainer width="100%" height={200}>
            <LineChart data={dadosGrafico}>
              ...
              <Tooltip
                ...
                formatter={(v) => [`${Math.floor(v)}:${Math.round((v%1)*60).toString().padStart(2,"0")} min/km`, "Pace"]}
              />
      ...
      {editando && (
        <Modal titulo="Editar Aluno" onClose={() => setEditando(false)}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            ...
            <Campo label="Data de início" value={form.dataInicio} onChange={v => setForm({ ...form, dataInicio: v })} type="date" />
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              ...
              <button onClick={() => setForm({ ...form, ativo: !form.ativo })} style={{
                background: form.ativo ? "#00A859" : "#333", border: "none", borderRadius: 20, padding: "6px 16px",
          ...
          <div style={{ display: "flex", gap: 10, marginTop: 20, justifyContent: "flex-end" }}>
            ...
            <Btn onClick={salvarAluno} icone={<Check size={14} />}>Salvar</Btn>
          </div>
        </Modal>
      )}
    </div>
...
const AbaCalendario = ({ dados, onUpdate, toast }) => {
  const hoje = new Date();
  ...
  const eventosDia = (dia) => dados.eventosCalendario.filter(e => e.data === dataStr(dia));

  const salvarEvento = () => {
    if (!form.nome || !form.alunoId) return;
    const data = modalAberto;
    if (eventoEdicao) {
      onUpdate("editarEvento", { id: eventoEdicao.id, ...form, data });
      toast("Evento atualizado!");
    } else {
      onUpdate("addEvento", { ...form, data, id: gerarId() });
      toast("Evento adicionado!");
    }
    setModalAberto(null);
    setEventoEdicao(null);
    setForm({ alunoId: "", nome: "", distancia: "", tipo: "competição" });
  };

  const abrirDia = (dia) => {
    setModalAberto(dataStr(dia));
    setEventoEdicao(null);
    setForm({ alunoId: dados.alunos[0]?.id || "", nome: "", distancia: "", tipo: "competição" });
  };

  const abrirEditar = (ev) => {
    setEventoEdicao(ev);
    setModalAberto(ev.data);
    setForm({ alunoId: ev.alunoId, nome: ev.nome, distancia: ev.distancia, tipo: ev.tipo });
  };

  const proximas = [...dados.eventosCalendario]
    .filter(e => e.data >= hoje.toISOString().slice(0, 10))
    .sort((a, b) => a.data.localeCompare(b.data))
    .slice(0, 10);
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 280px", gap: 20, alignItems: "start" }}>
      ...
      <div style={{ background: "#111", border: "1px solid #222", borderRadius: 16, padding: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
          <button onClick={() => { let m = mesAtual - 1; let a = anoAtual; if (m < 0) { m = 11; a--; } setMesAtual(m); setAnoAtual(a); }} style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: 8, padding: 8, color: "#fff", cursor: "pointer" }}><ChevronLeft size={16} /></button>
          <h2 style={{ color: "#fff", fontSize: 17, fontWeight: 700, margin: 0 }}>{nomeMes(mesAtual)} {anoAtual}</h2>
          <button onClick={() => { let m = mesAtual + 1; let a = anoAtual; if (m > 11) { m = 0; a++; } setMesAtual(m); setAnoAtual(a); }} style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: 8, padding: 8, color: "#fff", cursor: "pointer" }}><ChevronRight size={16} /></button>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 4, marginBottom: 8 }}>
          {["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"].map(d => (
            <div key={d} style={{ textAlign: "center", color: "#555", fontSize: 12, fontWeight: 700, padding: "4px 0" }}>{d}</div>
          ))}
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 4 }}>
          ...
          {Array.from({ length: diasNoMes }).map((_, i) => {
            ...
            return (
              <div key={dia} onClick={() => abrirDia(dia)} style={{
                minHeight: 70, background: isHoje ? "#00A85915" : "#1a1a1a",
                border: isHoje ? "1px solid #00A85966" : "1px solid #222",
                borderRadius: 8, padding: "6px 8px", cursor: "pointer",
                transition: "background 0.2s",
              }}>
                <div style={{ color: isHoje ? "#00A859" : "#888", fontSize: 12, fontWeight: isHoje ? 800 : 500, marginBottom: 4 }}>{dia}</div>
                {evs.map(ev => {
                  const al = dados.alunos.find(a => a.id === ev.alunoId);
                  return (
                    <div key={ev.id} onClick={(e) => { e.stopPropagation(); abrirEditar(ev); }} style={{
                      background: ev.tipo === "competição" ? "#00A85933" : "#0088CC33",
                      color: ev.tipo === "competição" ? "#00A859" : "#60AADD",
                      fontSize: 10, borderRadius: 4, padding: "2px 6px", marginBottom: 2,
      ...
      {modalAberto && (
        <Modal titulo={eventoEdicao ? "Editar Evento" : `Adicionar Evento — ${modalAberto}`} onClose={() => { setModalAberto(null); setEventoEdicao(null); }}>
          ...
          <div style={{ display: "flex", gap: 10, justifyContent: "space-between", marginTop: 20 }}>
            {eventoEdicao && (
              <Btn variante="perigo" icone={<Trash2 size={14} />} onClick={() => { onUpdate("removerEvento", { id: eventoEdicao.id }); setModalAberto(null); setEventoEdicao(null); toast("Evento removido!"); }}>Excluir</Btn>
            )}
...
const AbaFinanceiro = ({ dados, onUpdate, toast }) => {
  const hoje = new Date();
  ...
  const alunosFiltrados = dados.alunos.filter(a => {
    const pg = dados.pagamentos[a.id]?.[chave];
    const status = pg?.status || "pendente";
    if (filtro === "pagos") return status === "pago";
    if (filtro === "pendentes") return status === "pendente";
    return true;
  });

  const totalReceber = dados.alunos.reduce((s, a) => s + (+a.mensalidade || 0), 0);
  const totalRecebido = dados.alunos.reduce((s, a) => {
    const pg = dados.pagamentos[a.id]?.[chave];
    return s + (pg?.status === "pago" ? +a.mensalidade || 0 : 0);
  }, 0);
  ...
  const togglePagamento = (alunoId) => {
    const pg = dados.pagamentos[alunoId]?.[chave];
    const novoStatus = pg?.status === "pago" ? "pendente" : "pago";
    const novaData = novoStatus === "pago" ? hoje.toISOString().slice(0, 10) : "";
    onUpdate("setPagamento", { alunoId, chave, status: novoStatus, data: novaData, obs: pg?.obs || "" });
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16, flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <button onClick={() => { let m = mesIdx - 1; let a = anoIdx; if (m < 0) { m = 11; a--; } setMesIdx(m); setAnoIdx(a); }} style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: 8, padding: 7, color: "#fff", cursor: "pointer" }}><ChevronLeft size={15} /></button>
          <span style={{ color: "#fff", fontWeight: 700, minWidth: 140, textAlign: "center" }}>{nomeMes(mesIdx)} {anoIdx}</span>
          <button onClick={() => { let m = mesIdx + 1; let a = anoIdx; if (m > 11) { m = 0; a++; } setMesIdx(m); setAnoIdx(a); }} style={{ background: "#1a1a1a", border: "1px solid #333", borderRadius: 8, padding: 7, color: "#fff", cursor: "pointer" }}><ChevronRight size={15} /></button>
        </div>
        <div style={{ display: "flex", gap: 6 }}>
          {["todos","pagos","pendentes"].map(f => (
            <button key={f} onClick={() => setFiltro(f)} style={{
              background: filtro === f ? "#00A859" : "#1a1a1a",
              border: "1px solid #333", borderRadius: 8, padding: "6px 14px",
              color: "#fff", cursor: "pointer", fontSize: 13, fontWeight: 600, textTransform: "capitalize",
            }}>{f}</button>
          ))}
        </div>
      </div>
      ...
      <div style={{ background: "#111", border: "1px solid #222", borderRadius: 16, overflowX: "auto" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          <thead>
            <tr>
              {["Aluno","Plano","Mensalidade","Status","Data Pgto","Observações","Ação"].map(h => (
                <th key={h} style={{ color: "#555", fontWeight: 600, textAlign: "left", padding: "12px 16px", borderBottom: "1px solid #222" }}>{h}</th>
              ))}
            </tr>
          </thead>
          <tbody>
            {alunosFiltrados.map(aluno => {
              const pg = dados.pagamentos[aluno.id]?.[chave] || { status: "pendente", data: "", obs: "" };
              return (
                <tr key={aluno.id} style={{ borderBottom: "1px solid #1a1a1a" }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <span style={{ background: pg.status === "pago" ? "#00A85922" : "#E74C3C22", color: pg.status === "pago" ? "#00A859" : "#E74C3C", padding: "3px 10px", borderRadius: 20, fontWeight: 700, fontSize: 12 }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <button onClick={() => togglePagamento(aluno.id)} style={{
                      background: pg.status === "pago" ? "#1a1a1a" : "#00A859",
                      border: "1px solid #333", borderRadius: 7, padding: "5px 12px",
                      color: "#fff", cursor: "pointer", fontSize: 12, fontWeight: 700,
                    }}>{pg.status === "pago" ? "Desmarcar" : "Marcar Pago"}</button>
                  </td>
                </tr>
              );
            })}
...
const AbaCalculadora = () => {
  ...
  const calcular = () => {
    if (modo === "paceTempo") {
      ...
      const totalSegs = paceSegs * +distancia;
      setResultado({ tipo: "tempo", valor: segundosParaTempo(totalSegs), extra: `${(3600 / paceSegs).toFixed(2)} km/h` });
    } else if (modo === "tempoPace") {
      if (!distancia || !tempo) return;
      const p = calcularPace(+distancia, tempo);
      const segs = tempoParaSegundos(tempo);
      const vel = ((+distancia / segs) * 3600).toFixed(2);
      setResultado({ tipo: "pace", valor: p + " min/km", extra: `${vel} km/h` });
    } else {
      if (!velocidade) return;
      const paceSegs = 3600 / +velocidade;
      const min = Math.floor(paceSegs / 60);
      const sec = Math.round(paceSegs % 60).toString().padStart(2, "0");
      setResultado({ tipo: "pace", valor: `${min}:${sec} min/km`, extra: `${(+velocidade).toFixed(1)} km/h` });
    }
  };
  ...
  const tabela = useMemo(() => {
    ...
    const paceSegs = min * 60 + (sec || 0);
    return [
      { dist: "1 km", tempo: segundosParaTempo(paceSegs * 1) },
      { dist: "5 km", tempo: segundosParaTempo(paceSegs * 5) },
      { dist: "10 km", tempo: segundosParaTempo(paceSegs * 10) },
      { dist: "21,1 km", tempo: segundosParaTempo(paceSegs * 21.1) },
      { dist: "42,2 km", tempo: segundosParaTempo(paceSegs * 42.195) },
    ];
  }, [pace]);
  ...
  return (
    <div style={{ maxWidth: 700 }}>
      <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
        {[["paceTempo","Pace → Tempo"],["tempoPace","Tempo → Pace"],["velPace","Velocidade → Pace"]].map(([m, label]) => (
          <button key={m} onClick={() => { setModo(m); setResultado(null); }} style={{
            background: modo === m ? "#00A859" : "#1a1a1a",
            border: "1px solid #333", borderRadius: 8, padding: "8px 16px",
            color: "#fff", cursor: "pointer", fontSize: 13, fontWeight: 700,
          }}>{label}</button>
        ))}
      </div>
      ...
      <div style={{ background: "#111", border: "1px solid #222", borderRadius: 16, padding: 28 }}>
        {modo === "paceTempo" && (
          <>
            <Campo label="Distância (km)" value={distancia} onChange={setDistancia} type="number" placeholder="Ex: 10" />
            <Campo label="Pace (min:seg por km)" value={pace} onChange={setPace} placeholder="Ex: 5:30" />
          </>
        )}
        {modo === "tempoPace" && (
          <>
            <Campo label="Distância (km)" value={distancia} onChange={setDistancia} type="number" placeholder="Ex: 21.1" />
            <Campo label="Tempo total (hh:mm:ss)" value={tempo} onChange={setTempo} placeholder="Ex: 01:48:30" />
          </>
        )}
        {modo === "velPace" && (
          <Campo label="Velocidade (km/h)" value={velocidade} onChange={setVelocidade} type="number" placeholder="Ex: 12" />
        )}
      ...
      {tabela.length > 0 && (
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: 16, padding: 20, marginTop: 20 }}>
          <h3 style={{ color: "#fff", fontSize: 14, fontWeight: 700, margin: "0 0 14px" }}>Tabela de Referência para Pace {pace}</h3>
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead>
              <tr>
                <th style={{ color: "#555", textAlign: "left", padding: "8px 0", fontWeight: 600, fontSize: 12 }}>Distância</th>
                <th style={{ color: "#555", textAlign: "right", padding: "8px 0", fontWeight: 600, fontSize: 12 }}>Tempo Estimado</th>
              </tr>
            </thead>
            <tbody>
              {tabela.map(r => (
                <tr key={r.dist} style={{ borderTop: "1px solid #1a1a1a" }}>
                  <td style={{ color: "#aaa", padding: "10px 0", fontSize: 14 }}>{r.dist}</td>
                  <td style={{ color: "#fff", padding: "10px 0", fontSize: 14, fontWeight: 700, textAlign: "right" }}>{r.tempo}</td>
                </tr>
              ))}
            </tbody>
          </table>
...
const tipos = {
  Leve: { bg: "#00A85933", color: "#00A859" },
  Moderado: { bg: "#F39C1233", color: "#F39C12" },
  Forte: { bg: "#E74C3C33", color: "#E74C3C" },
  Descanso: { bg: "#33333344", color: "#888" },
  Prova: { bg: "#9B59B633", color: "#9B59B6" },
  "": { bg: "transparent", color: "#555" },
};

const AbaPlanilha = ({ dados, onUpdate, toast }) => {
  const [alunoId, setAlunoId] = useState(dados.alunos[0]?.id || "");
  const hoje = new Date();
  ...
  const offsetInicio = (diaSemana + 6) % 7;
  const totalDias = new Date(hoje.getFullYear(), hoje.getMonth() + 1, 0).getDate();
  const totalSemanas = Math.ceil((totalDias + offsetInicio) / 7);
  const semanas = Array.from({ length: totalSemanas }, (_, si) =>
    Array.from({ length: 7 }, (_, di) => {
      const diaNum = si * 7 + di - offsetInicio + 1;
      if (diaNum < 1 || diaNum > totalDias) return null;
      return diaNum;
    })
  );

  const treinos = dados.treinos[alunoId] || {};
  const chave = (dia) => `${hoje.getFullYear()}-${String(hoje.getMonth() + 1).padStart(2, "0")}-${String(dia).padStart(2, "0")}`;
  const getTreino = (dia) => treinos[chave(dia)] || { tipo: "", distancia: "", obs: "" };

  const editarTreino = (dia, campo, valor) => {
    const t = { ...getTreino(dia), [campo]: valor };
    onUpdate("editarTreino", { alunoId, chave: chave(dia), treino: t });
  };

  const exportar = () => {
    let txt = `Planilha de Treinos — ${dados.alunos.find(a => a.id === alunoId)?.nome}\n\n`;
    semanas.forEach((sem, si) => {
      txt += `Semana ${si + 1}:\n`;
      sem.forEach((dia, di) => {
        if (!dia) return;
        const t = getTreino(dia);
        txt += `  ${diasSemana[di]} ${dia}: ${t.tipo || "–"} ${t.distancia ? t.distancia + "km" : ""} ${t.obs ? "/ " + t.obs : ""}\n`;
      });
      txt += "\n";
    });
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
          <div style={{ display: "flex", gap: 6 }}>
            {Object.entries(tipos).filter(([k]) => k).map(([k, v]) => (
              <span key={k} style={{ background: v.bg, color: v.color, fontSize: 11, padding: "3px 8px", borderRadius: 6, fontWeight: 700 }}>{k}</span>
            ))}
          </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 8 }}>
        {diasSemana.map(d => (
          <div key={d} style={{ textAlign: "center", color: "#555", fontSize: 12, fontWeight: 700, paddingBottom: 6 }}>{d}</div>
        ))}
        {(semanas[semana] || []).map((dia, di) => {
          if (!dia) return <div key={di} style={{ background: "#0a0a0a", borderRadius: 10, minHeight: 130, opacity: 0.3 }} />;
          const t = getTreino(dia);
          const tc = tipos[t.tipo] || tipos[""];
          return (
            <div key={dia} style={{ background: "#111", border: "1px solid #222", borderRadius: 10, padding: 10, minHeight: 130 }}>
              ...
              <select value={t.tipo} onChange={(e) => editarTreino(dia, "tipo", e.target.value)} style={{ width: "100%", background: tc.bg, border: "none", borderRadius: 5, padding: "4px 6px", color: tc.color, fontSize: 11, fontWeight: 700, outline: "none", marginBottom: 6 }}>
                <option value="">–</option>
                {Object.keys(tipos).filter(k => k).map(k => <option key={k} value={k}>{k}</option>)}
              </select>
              <input type="number" value={t.distancia} onChange={(e) => editarTreino(dia, "distancia", e.target.value)} placeholder="km" style={{ width: "100%", background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: 5, padding: "4px 6px", color: "#fff", fontSize: 11, outline: "none", marginBottom: 4, boxSizing: "border-box" }} />
              <input value={t.obs} onChange={(e) => editarTreino(dia, "obs", e.target.value)} placeholder="obs..." style={{ width: "100%", background: "#1a1a1a", border: "1px solid #2a2a2a", borderRadius: 5, padding: "4px 6px", color: "#aaa", fontSize: 10, outline: "none", boxSizing: "border-box" }} />
            </div>
          );
        })}
      </div>
...
const AbaRelatorios = ({ dados }) => {
  const hoje = new Date();
  const mesAtual = `${hoje.getFullYear()}-${String(hoje.getMonth() + 1).padStart(2, "0")}`;
  const totalAtivos = dados.alunos.filter(a => a.ativo).length;
  const totalProvasMes = Object.values(dados.provasPassadas).flat().filter(p => p.data?.startsWith(mesAtual.substring(0, 7))).length;
  const receitaMes = dados.alunos.reduce((s, a) => {
    const pg = dados.pagamentos[a.id]?.[mesAtual];
    return s + (pg?.status === "pago" ? +a.mensalidade || 0 : 0);
  }, 0);
  const emDebito = dados.alunos.filter(a => {
    const pg = dados.pagamentos[a.id]?.[mesAtual];
    return !pg || pg.status === "pendente";
  }).length;

  // Ranking pace médio
  const rankingPace = dados.alunos.map(a => {
    const ps = (dados.provasPassadas[a.id] || []).map(p => p.pace && paceParaSegundos(p.pace)).filter(Boolean);
  ...
  const receitaMeses = Array.from({ length: 6 }, (_, i) => {
    ...
    const rec = dados.alunos.reduce((s, a) => {
      const pg = dados.pagamentos[a.id]?.[k];
      return s + (pg?.status === "pago" ? +a.mensalidade || 0 : 0);
    }, 0);
    return { mes: nomeMes(d.getMonth()).slice(0, 3), receita: rec };
  });
...
export default function EndorfinaClub() {
  ...
  const [formNovoAluno, setFormNovoAluno] = useState({ nome: "", idade: "", cidade: "", telefone: "", email: "", plano: "Básico", mensalidade: 200, foto: "", dataInicio: new Date().toISOString().slice(0, 10), ativo: true });
  ...
  const onUpdate = useCallback((acao, payload) => {
    setDados(d => {
      const novo = JSON.parse(JSON.stringify(d));
      switch (acao) {
        case "editarAluno": {
          const idx = novo.alunos.findIndex(a => a.id === payload.id);
          if (idx >= 0) novo.alunos[idx] = payload;
          break;
        }
        case "addAluno": {
          novo.alunos.push(payload);
          novo.provasPassadas[payload.id] = [];
          novo.provasFuturas[payload.id] = [];
          novo.pagamentos[payload.id] = {};
          novo.treinos[payload.id] = {};
          break;
        }
        case "removerAluno": {
          novo.alunos = novo.alunos.filter(a => a.id !== payload.id);
          delete novo.provasPassadas[payload.id];
          delete novo.provasFuturas[payload.id];
          delete novo.pagamentos[payload.id];
          delete novo.treinos[payload.id];
          break;
        }
        case "addProvaPassada": {
          if (!novo.provasPassadas[payload.alunoId]) novo.provasPassadas[payload.alunoId] = [];
          novo.provasPassadas[payload.alunoId].push({ id: gerarId(), data: "", nome: "", distancia: "", tempo: "", pace: "" });
          break;
        }
        case "removeProvaPassada": {
          novo.provasPassadas[payload.alunoId].splice(payload.index, 1);
          break;
        }
        case "editProvaPassada": {
          const pp = novo.provasPassadas[payload.alunoId][payload.index];
          pp[payload.key] = payload.val;
          if ((payload.key === "tempo" || payload.key === "distancia") && pp.tempo && pp.distancia) {
            pp.pace = calcularPace(+pp.distancia, pp.tempo);
          }
          break;
        }
        case "addProvaFutura": {
          if (!novo.provasFuturas[payload.alunoId]) novo.provasFuturas[payload.alunoId] = [];
          novo.provasFuturas[payload.alunoId].push({ id: gerarId(), data: "", nome: "", distancia: "", objetivoTempo: "", objetivoPace: "" });
          break;
        }
        case "removeProvaFutura": {
          novo.provasFuturas[payload.alunoId].splice(payload.index, 1);
          break;
        }
        case "editProvaFutura": {
          novo.provasFuturas[payload.alunoId][payload.index][payload.key] = payload.val;
          break;
        }
        case "addEvento": {
          novo.eventosCalendario.push(payload);
          break;
        }
        case "editarEvento": {
          const idx = novo.eventosCalendario.findIndex(e => e.id === payload.id);
          if (idx >= 0) novo.eventosCalendario[idx] = { ...novo.eventosCalendario[idx], ...payload };
          break;
        }
        case "removerEvento": {
          novo.eventosCalendario = novo.eventosCalendario.filter(e => e.id !== payload.id);
          break;
        }
        case "setPagamento": {
          if (!novo.pagamentos[payload.alunoId]) novo.pagamentos[payload.alunoId] = {};
          novo.pagamentos[payload.alunoId][payload.chave] = { status: payload.status, data: payload.data, obs: payload.obs };
          break;
        }
        case "setObsPagamento": {
          if (!novo.pagamentos[payload.alunoId]) novo.pagamentos[payload.alunoId] = {};
          if (!novo.pagamentos[payload.alunoId][payload.chave]) novo.pagamentos[payload.alunoId][payload.chave] = { status: "pendente", data: "", obs: "" };
          novo.pagamentos[payload.alunoId][payload.chave].obs = payload.obs;
          break;
        }
        case "editMensalidade": {
          const idx = novo.alunos.findIndex(a => a.id === payload.id);
          if (idx >= 0) novo.alunos[idx].mensalidade = payload.valor;
          break;
        }
        case "editarTreino": {
          if (!novo.treinos[payload.alunoId]) novo.treinos[payload.alunoId] = {};
          novo.treinos[payload.alunoId][payload.chave] = payload.treino;
          break;
        }
      }
      return novo;
  ...
  const adicionarAluno = () => {
    ...
    onUpdate("addAluno", novo);
    setModalNovoAluno(false);
    setFormNovoAluno({ nome: "", idade: "", cidade: "", telefone: "", email: "", plano: "Básico", mensalidade: 200, foto: "", dataInicio: new Date().toISOString().slice(0, 10), ativo: true });
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: "#000", fontFamily: "'Inter', system-ui, sans-serif", overflow: "hidden" }}>
      ...
      {/* SIDEBAR */}
      <div style={{
        width: sidebarAberta ? 240 : 64, minWidth: sidebarAberta ? 240 : 64,
        ...
        <div style={{ padding: "20px 16px", borderBottom: "1px solid #1a1a1a", display: "flex", alignItems: "center", gap: 10, justifyContent: sidebarAberta ? "flex-start" : "center" }}>
          ...
          {sidebarAberta && (
            <div>
              <span style={{ color: "#fff", fontWeight: 900, fontSize: 16, letterSpacing: -0.5 }}>Endorfina</span>
              <span style={{ color: "#00A859", fontWeight: 900, fontSize: 16, letterSpacing: -0.5 }}> Club</span>
            </div>
          )}
        </div>
        ...
        <nav style={{ flex: 1, padding: "12px 8px", overflow: "auto" }}>
          {abas.map(aba => (
            <button key={aba.id} onClick={() => { setAbaAtiva(aba.id); if (aba.id !== "alunos") setAlunoSelecionado(null); }} style={{
              width: "100%", display: "flex", alignItems: "center", gap: 10,
              padding: sidebarAberta ? "10px 12px" : "10px", justifyContent: sidebarAberta ? "flex-start" : "center",
              background: abaAtiva === aba.id ? "#00A85922" : "transparent",
              border: "none", borderRadius: 9,
              color: abaAtiva === aba.id ? "#00A859" : "#666",
              cursor: "pointer", marginBottom: 2, fontWeight: abaAtiva === aba.id ? 700 : 500,
              fontSize: 14, transition: "all 0.15s", whiteSpace: "nowrap",
            }}>
              {aba.icone}
              {sidebarAberta && aba.label}
            </button>
          ))}
        </nav>

        {/* Lista de alunos (só na aba alunos com sidebar aberta) */}
        {abaAtiva === "alunos" && sidebarAberta && (
          <div style={{ borderTop: "1px solid #1a1a1a", maxHeight: 320, overflow: "auto" }}>
            <div style={{ padding: "10px 12px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => setModalNovoAluno(true)} style={{ background: "#00A85922", border: "none", borderRadius: 6, padding: "3px 8px", color: "#00A859", cursor: "pointer", display: "flex", alignItems: "center", gap: 3, fontSize: 11, fontWeight: 700 }}>
                <Plus size={11} /> Novo
              </button>
            </div>
            {dados.alunos.map(a => (
              <div key={a.id} onClick={() => setAlunoSelecionado(a.id)} style={{
                padding: "8px 12px", display: "flex", alignItems: "center", gap: 10, cursor: "pointer",
                background: alunoSelecionado === a.id ? "#00A85915" : "transparent",
                borderLeft: alunoSelecionado === a.id ? "2px solid #00A859" : "2px solid transparent",
              }}>
                ...
                <button onClick={(e) => { e.stopPropagation(); if (confirm(`Remover ${a.nome}?`)) { onUpdate("removerAluno", { id: a.id }); if (alunoSelecionado === a.id) setAlunoSelecionado(null); mostrarToast("Aluno removido"); } }} style={{ background: "none", border: "none", color: "#444", cursor: "pointer", padding: 4, opacity: 0, transition: "opacity 0.15s" }} className="del-btn">
                  <Trash2 size={12} />
                </button>
              </div>
            ))}
      ...
      <div style={{ flex: 1, overflow: "auto", padding: "28px 32px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 28 }}>
          <div>
            {abaAtiva === "alunos" && alunoSelecionado ? (
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                <button onClick={() => setAlunoSelecionado(null)} style={{ background: "#1a1a1a", border: "1px solid #222", borderRadius: 8, padding: "6px 12px", color: "#aaa", cursor: "pointer", display: "flex", alignItems: "center", gap: 6, fontSize: 13 }}>
                  <ChevronLeft size={14} /> Voltar
                </button>
                <h1 style={{ color: "#fff", fontSize: 22, fontWeight: 900, margin: 0 }}>
                  {dados.alunos.find(a => a.id === alunoSelecionado)?.nome}
                </h1>
              </div>
            ) : (
              <h1 style={{ color: "#fff", fontSize: 22, fontWeight: 900, margin: 0 }}>
          ...
          {abaAtiva === "alunos" && !alunoSelecionado && (
            <Btn onClick={() => setModalNovoAluno(true)} icone={<Plus size={15} />}>Novo Aluno</Btn>
          )}
        </div>
        ...
        {abaAtiva === "alunos" && (
          alunoSelecionado ? (
            <DashboardAluno
              aluno={dados.alunos.find(a => a.id === alunoSelecionado)}
              dados={dados}
              onUpdate={onUpdate}
              toast={mostrarToast}
            />
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 16 }}>
              {dados.alunos.map(aluno => (
                <div key={aluno.id} onClick={() => setAlunoSelecionado(aluno.id)} style={{
                  ...
                  <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                    <span style={{ background: aluno.ativo ? "#00A85922" : "#33333322", color: aluno.ativo ? "#00A859" : "#666", fontSize: 11, padding: "3px 10px", borderRadius: 20, fontWeight: 700 }}>
                      {aluno.ativo ? "Ativo" : "Inativo"}
                    </span>
                    <span style={{ background: "#1a1a1a", color: "#888", fontSize: 11, padding: "3px 10px", borderRadius: 20 }}>
                      {(dados.provasPassadas[aluno.id] || []).length} provas
                    </span>
                    <span style={{ background: "#1a1a1a", color: "#888", fontSize: 11, padding: "3px 10px", borderRadius: 20 }}>
                      R$ {aluno.mensalidade}/mês
                    </span>
                  </div>
                </div>
              ))}
              {dados.alunos.length === 0 && (
                <div style={{ color: "#444", fontSize: 15, gridColumn: "1/-1", textAlign: "center", padding: 40 }}>
        ...
        {abaAtiva === "calendario" && <AbaCalendario dados={dados} onUpdate={onUpdate} toast={mostrarToast} />}
        {abaAtiva === "financeiro" && <AbaFinanceiro dados={dados} onUpdate={onUpdate} toast={mostrarToast} />}
        {abaAtiva === "calculadora" && <AbaCalculadora />}
        {abaAtiva === "planilha" && <AbaPlanilha dados={dados} onUpdate={onUpdate} toast={mostrarToast} />}
        {abaAtiva === "relatorios" && <AbaRelatorios dados={dados} />}
      </div>
        ...
        <Modal titulo="Adicionar Novo Aluno" onClose={() => setModalNovoAluno(false)}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
            <div style={{ gridColumn: "1/-1" }}>
              <Campo label="Nome completo *" value={formNovoAluno.nome} onChange={v => setFormNovoAluno({ ...formNovoAluno, nome: v })} placeholder="Ex: João da Silva" />
            </div>
            ...
            <Campo label="Email" value={formNovoAluno.email} onChange={v => setFormNovoAluno({ ...formNovoAluno, email: v })} type="email" placeholder="email@exemplo.com" />
            ...
            <Campo label="Data de início" value={formNovoAluno.dataInicio} onChange={v => setFormNovoAluno({ ...formNovoAluno, dataInicio: v })} type="date" />
            <div style={{ gridColumn: "1/-1" }}>
              <Campo label="URL da foto (opcional)" value={formNovoAluno.foto} onChange={v => setFormNovoAluno({ ...formNovoAluno, foto: v })} placeholder="https://..." />
            </div>
          </div>
          <div style={{ display: "flex", gap: 10, marginTop: 20, justifyContent: "flex-end" }}>
